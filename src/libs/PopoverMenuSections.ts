...
const TRANSACTION_MORE_MENU_SECTIONS = [
    [TRANSACTION_SECONDARY_ACTIONS.HOLD, TRANSACTION_SECONDARY_ACTIONS.REMOVE_HOLD, TRANSACTION_SECONDARY_ACTIONS.REJECT],
    [TRANSACTION_SECONDARY_ACTIONS.SPLIT, TRANSACTION_SECONDARY_ACTIONS.MERGE, TRANSACTION_SECONDARY_ACTIONS.DUPLICATE, TRANSACTION_SECONDARY_ACTIONS.MOVE_EXPENSE],
